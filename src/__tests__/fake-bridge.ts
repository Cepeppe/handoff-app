...
export function fakeBridge(overrides: Partial<Bridge> = {}): Bridge {
  ...
  const spied: Bridge = {
    ...
    analyzeCapture: vi.fn(base.analyzeCapture),
    editPreview: vi.fn(base.editPreview),
    previewText: vi.fn(base.previewText),
    sendScreenshot: vi.fn(base.sendScreenshot),
    ...
    logEntries: vi.fn(base.logEntries),
    logDetail: vi.fn(base.logDetail),
    ...
    deleteRunbook: vi.fn(base.deleteRunbook),
    resolveRunbookProposal: vi.fn(base.resolveRunbookProposal),
